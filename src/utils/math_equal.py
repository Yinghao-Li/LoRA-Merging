...
__all__ = ["is_math_express_equiv", "is_answer_correct", "get_boxed_content"]
...
def is_math_express_equiv(str1, str2, verbose=False):
    if str1 is None and str2 is None:
        logger.warning("Both math expression are None!")
        return True
